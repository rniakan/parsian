...
class Personal_Species_Model(models.Model):
    ...
    # examinations_code = models.CharField(max_length=250, blank=True)
    user = models.CharField(max_length=250, null=True, blank=True)
    examinations_type_CHOICES = [('badv_estekhdam', 'بدو استخدام'), ('dore_e', 'دوره ای'),
                                 ('bazgasht_be_kar', 'بازگشت به کار')]
    ...
    marriage_status = models.CharField(default='mojarad', choices=marriage_status_CHOICES, max_length=250, null=True,
                                       blank=True)
    ...
    medical_exemption = models.CharField(default='none', choices=medical_exemption_CHOICES, max_length=250, null=True,
                                         blank=True)
    ...
    # class Meta:
    #     db_table = "ExaminationsCourse"

# منوی سوابق شغلی
class Job_History_Model(models.Model):
    person = models.ForeignKey(Personal_Species_Model, on_delete=models.CASCADE, related_name='history', null=True,
                               blank=True)
    # current job
    first_current_job = models.CharField(max_length=250, null=True, blank=True)
    second_current_job = models.CharField(max_length=250, null=True, blank=True)
    first_current_job_duty = models.CharField(max_length=250, null=True, blank=True)
    second_current_job_duty = models.CharField(max_length=250, null=True, blank=True)
    first_current_job_from_year = models.IntegerField(null=True, blank=True)
    first_current_job_from_month = models.IntegerField(null=True, blank=True)
    first_current_job_to_year = models.IntegerField(null=True, blank=True)
    first_current_job_to_month = models.IntegerField(null=True, blank=True)
    first_current_job_durations = models.IntegerField(null=True, blank=True)
    second_current_job_from_year = models.IntegerField(null=True, blank=True)
    second_current_job_from_month = models.IntegerField(null=True, blank=True)
    second_current_job_to_year = models.IntegerField(null=True, blank=True)
    second_current_job_to_month = models.IntegerField(null=True, blank=True)
    second_current_job_durations = models.IntegerField(null=True, blank=True)
    first_current_change_job_reason = models.CharField(max_length=250, null=True, blank=True)
    second_current_change_job_reason  = models.CharField(max_length=250, null=True, blank=True)
    # previous job
    first_previous_job = models.CharField(max_length=250, null=True, blank=True)
    second_previous_job = models.CharField(max_length=250, null=True, blank=True)
    first_previous_job_duty = models.CharField(max_length=250, null=True, blank=True)
    second_previous_job_duty = models.CharField(max_length=250, null=True, blank=True)
    first_previous_job_from = models.IntegerField(null=True, blank=True)
    first_previous_job_to = models.IntegerField(null=True, blank=True)
    first_previous_job_durations = models.IntegerField(null=True, blank=True)
    second_previous_job_from = models.IntegerField(null=True, blank=True)
    second_previous_job_to = models.IntegerField(null=True, blank=True)
    second_previous_job_durations = models.IntegerField(null=True, blank=True)
    first_previous_change_job_reason = models.CharField(max_length=250, null=True, blank=True)
    second_previous_change_job_reason = models.CharField(max_length=250, null=True, blank=True)
...
class Assessment_Model(models.Model):
    person = models.ForeignKey(Personal_Species_Model, on_delete=models.CASCADE, related_name='assessment', null=True,
                               blank=True)
...
class Personal_History_Model(models.Model):
    person = models.ForeignKey(Personal_Species_Model, on_delete=models.CASCADE, related_name='personalhistory',
                               null=True, blank=True)
...
class Examinations_Model(models.Model):
    person = models.ForeignKey(Personal_Species_Model, on_delete=models.CASCADE, related_name='examinations', null=True,
                               blank=True)
    ...
    min_blood_pressure = models.IntegerField(null=True, blank=True)
    max_blood_pressure = models.IntegerField(null=True, blank=True)
...
class Experiments_Model(models.Model):
    person = models.ForeignKey(Personal_Species_Model, on_delete=models.CASCADE, related_name='experiment', null=True,
                               blank=True)
...
class Para_Clinic_Model(models.Model):
    person = models.ForeignKey(Personal_Species_Model, on_delete=models.CASCADE, related_name='para', null=True,
                               blank=True)
    ...
    opto_Description = models.CharField(null=True, blank=True, max_length=250, choices=opto_l_CHOICES)
    ...
    audio_r_status_CHOICES = [('normal', 'نرمال'), ('kahesh_shenavai_hedayati', 'کاهش شنوایی هدایتی'),
                              ('kahesh_shenavai_hesi_asabi', 'کاهش شنوایی حسی عصبی'),
                              ('kahesh_shenavai_nashi_az_seda', 'کاهش شنوایی ناشی از صدا'),
                              ('toaman_hedayati_va_hesi_asabi', 'توامان هدایتی و حسی عصبی')]
    audio_r_tafsir = models.CharField(max_length=250, choices=audio_r_status_CHOICES, null=True, blank=True)
    audio_l_status_CHOICES = [('normal', 'نرمال'), ('kahesh_shenavai_hedayati', 'کاهش شنوایی هدایتی'),
                              ('kahesh_shenavai_hesi_asabi', 'کاهش شنوایی حسی عصبی'),
                              ('kahesh_shenavai_nashi_az_seda', 'کاهش شنوایی ناشی از صدا'),
                              ('toaman_hedayati_va_hesi_asabi', 'توامان هدایتی و حسی عصبی')]
    ...
    ESPIRO_TAFSIR_CHOICES = [('normal', 'نرمال'), ('ensedadi', 'انسدادی'), ('tahdidi', 'تحدیدی'),
                             ('ensedadivtahdidi', 'انسدادی و تحدیدی'), ('again', 'نیاز به تکرار')]
    ...
    description_cxr = models.CharField(max_length=250, null=True, blank=True)
    ...
    ecg_CHOICES = [('normal', 'نرمال'), ('not_normal', 'غیر نرمال'), ('not_ekhtesasi', 'تغییرات غیر اختصاصی'),
                   ('again', 'نیاز به تکرار')]
    other_ecg = models.CharField(max_length=250, choices=ecg_CHOICES, null=True, blank=True)
    description_ecg = models.CharField(max_length=250, null=True, blank=True)
...
class Consulting_Model(models.Model):
    person = models.ForeignKey(Personal_Species_Model, on_delete=models.CASCADE, related_name='consulting', null=True,
                               blank=True)
...
class Final_Theory_Model(models.Model):
    person = models.ForeignKey(Personal_Species_Model, on_delete=models.CASCADE, related_name='final', null=True,
                               blank=True)
