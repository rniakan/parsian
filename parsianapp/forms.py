...
class personal_species_form(forms.ModelForm):
    class Meta:
        ...
        'species_date_day' : forms.NumberInput(attrs={'class':'s_box','autocomplete': 'off','min'  : '1','max' : '31'})
        }
...
class job_history_form(forms.ModelForm):
    class Meta:
        ...
        'current_job_from_year' : forms.NumberInput(attrs={'class':'date_year','autocomplete': 'off','min'  : '1300','max' : '1500'}),
        'current_job_from_month' : forms.NumberInput(attrs={'class':'s_box','autocomplete': 'off','min'  : '1','max' : '12'}),
        'current_job_to_year' : forms.NumberInput(attrs={'class':'date_year','autocomplete': 'off','min'  : '1300','max' : '1500'}),
        'current_job_to_month' : forms.NumberInput(attrs={'class':'s_box','autocomplete': 'off','min'  : '1300','max' : '1500'}),
